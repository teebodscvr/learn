...
class ProjectState extends State<Project>{
    ...
    addListeners(listenersFn: Listener<Project>) {
        this.listeners.push(listenersFn);
    }
}
...
class ProjectItem extends Component<HTMLUListElement, HTMLLIElement> implements DDInterfaces.Draggable {
...
class ProjectList extends Component<HTMLDivElement, HTMLElement> implements DDInterfaces.DragTarget {
    ...
    configure(): void {
        ...
        projectState.addListeners((projects: Project[]) => {
            ...
            const relevantPorjects = projects.filter(
                (prj) => {
                    if(this.type === 'active') {
